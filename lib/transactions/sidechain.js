...
function createSidechain(secret, activeDelegates, blockTime, milestones, type, tokenShortName, secondSecret,offset,distance,totalAmount,fixedLastReward,genesis,status,seedPeers,nethash,previousTransactionId) {
